"""BMJ Agent — searches British Medical Journal."""
...
class BMJAgent(HealthOrgAgent):
    """Searches BMJ for medical research.
    
    Flow:
    1. Search BMJ → get article links
    ...
    async def _fetch_passage(self, client: httpx.AsyncClient, href: str) -> str:
        try:
            resp = await client.get(f"https://www.bmj.com{href}")
